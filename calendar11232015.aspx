...
<body id="Body1" runat="server" >
    	 ...
    	 <form id="frmBoatDetails"  runat="server"   class="">
	...
	<br />
		  Boat # <asp:Label ID="lblBoatID" runat="server"></asp:Label>
                ...
                <h2> Rental Details </h2>
                    ...
                    <p><span class="boat-page-item">Facility #:</span>  <asp:Literal ID="lblOwner" runat="server"></asp:Literal> </p>
...
<asp:Panel ID="pnlEndDateHide" runat="server">
 ...
 <asp:ListItem Text="July" Value="7"></asp:ListItem>
                        ...
                        <tr>
                            <td>
                         <asp:Calendar ID="calEndDate" runat="server" Width="400px" DayNameFormat="Shortest"

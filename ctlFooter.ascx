<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlFooter.ascx.cs" Inherits="ctlFooter" %>
           ...
           <footer class="full_width footer_block">
                ...
                <div class="container">
					<div class="row" >
						<div class="col-lg-3 col-sm-3 padbot20">
                            ...
                            <a href="mailto:info@rentaboat.spam" id="lnkMail"> <span style="unicode-bidi: bidi-override;direction: rtl;">moc.taobatner@ofni</span></a><br>
                             <ul class="social">
							<li class="icon1"><a href="https://twitter.com/RentABoat_com" target="_blank"alt="twitter"></a></li>
							<li class="icon2"><a href="https://m.facebook.com/RentaBoatcom-244505213935/?ref=bookmarks"target="_blank" alt="facebook"></a></li>
                    ...
                    <div class="row" >
                    	<div align="center">&copy; Copyright 2021 Rent A Boat, RentABoat.com &nbsp;&nbsp; | &nbsp;&nbsp;<a href="#">Privacy Policy</a><br>
                        1-888-610 BOAT (2628) | 320 South Country Rd. Brookhaven, NY 11719<br>

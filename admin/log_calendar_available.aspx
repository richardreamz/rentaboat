<%@ Page Language="C#" AutoEventWireup="true" CodeFile="log_calendar_available.aspx.cs" Inherits="admin_log_calendar_available" %>
             ...
             <table>
                 ...
                 <tr>
                     <td>
                            ...
                            <asp:GridView ID="gvBookedBoats" runat="server" AutoGenerateColumns="false" DataKeyNames="IN_BOATID" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="gvBookedBoats_SelectedIndexChanged">

                 <AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                 <Columns>
                    
                    <asp:TemplateField HeaderText="Boat Name">

                        <ItemTemplate>

                            <asp:LinkButton ID="lnkBoatName" runat="server" Text='<%#Bind("vc_name") %>' CommandName="Select"></asp:LinkButton>

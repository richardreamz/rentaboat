<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BoatOwnerSignup.aspx.cs" Inherits="admin_BoatOwnerSignup" MaintainScrollPositionOnPostback="true" %>
...
<body class="body">
    <form id="frmHowToRent" runat="server">
                  ...
                  <ul class="navigation-menu">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu sub-menu" aria-labelledby="navbarDropdown2">
                          ...
                          <a class="dropdown-item" href="./BoatOwnerSignup.aspx" >List Your Boat</a>
        ...
        <section class="section pb-4 mt-5">
            <div id="signup-container" class="container mt-4">
                <div class="row">
                    <div class="col-lg-6 padbot20">
                        <h2 class="mb-4">List Your Boat Today!</h2>
                        ...
                        <div id="contact-form" class="contact-form">
                            ...
                            <div class="form-group row">
                                ...
                                <asp:TextBox ID="txtFacilityName" runat="server" CssClass="input-xlarge"></asp:TextBox>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="textinput">Email:</label>
                                <asp:TextBox ID="txtEmail" runat="server" CssClass="input-xlarge"></asp:TextBox>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="textinput">Confirm Email:</label>
                                <asp:TextBox ID="txtEmailConfirm" runat="server" CssClass="input-xlarge"></asp:TextBox>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="textinput">Password:</label>
                                <asp:TextBox ID="txtSignupPassword" runat="server" CssClass="input-xlarge"></asp:TextBox>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="textinput">Confirm Password:</label>
                                <asp:TextBox ID="txtSignupPasswordConfirm" runat="server" CssClass="input-xlarge"></asp:TextBox>
                            </div>
                            <div class="form-group row">
                                <input type="checkbox" style="width: 15px; height: 15px; padding: 10px 0" name="chkAccept" id="chkAccept">I accept the <a href="javascript:ShowTC()" spellcheck style="color: black; font-weight: bold">Terms and Conditions</a> and agree with them.</div>
                            </div>
                        <br>

                        <br>
                        <span id="lblMessage" style="color: Red; font-size: Medium; font-weight: bold;"></span>
                        <br>
                        ...
                        <div class="btns" style="padding-left: 160px;">
                            ...
                            <a id="btnClear" class="btn2" href="javascript:__doPostBack('btnClear','')">Clear</a>
                        </div>
                        <div class="btns" style="padding-left: 20px;">

                            <a onclick="return ValidateInput();" id="btnSave" class="btn2" href="javascript:__doPostBack('btnSave','')">Save</a>
                        </div>


                    </div>
                    <div class="col-lg-6">
                        <img style="max-width: 100%" src="img/signup.jpg" />
                    </div>
                </div>
            </div>
        </section>

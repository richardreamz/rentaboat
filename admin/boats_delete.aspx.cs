...
namespace BoatRenting {
  ...
  public partial class boats_delete_aspx_cs : System.Web.UI.Page
  {
    public string con = "";
    ...
    public object DeleteReg(double boat_ID) 
    {
        ...
        //cmd.Parameters[2].Value = boat_ID;

...
*/
	...
	if (Request.Form["rdo_fee"] == "0"){
		if (NVL(Request.Form["txt_fee0"], "") == ""){
			errorMsg += "\\n\\t Commission Fee \\t\\t  - Enter Fee per Click";
		}
	}

    if (Request.Form["rdo_fee"] == "1")
    {
...
if (Request.Form["rdo_fee"] == "3"){
    ...
    private String save()
    {
        ...
        if (txt_feeType == "0")
        {
            txt_fee = Request.Form["txt_fee0"];
        }
        else if (txt_feeType == "1")
        {

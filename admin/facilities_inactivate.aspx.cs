...
namespace BoatRenting {
  ...
  public partial class facilities_inactivate_aspx_cs : System.Web.UI.Page
  {
    public string con = "";
    ...
    public object InactivateReg(double marina_ID) 
    {
        ...
        //.execute()
        cmd.CommandText = "SP_BR_MARINA_INACTIVATE_UPD";
        cmd.CommandType = adCmdStoredProc;
        //cmd.Parameters[1].Value = marina_ID;

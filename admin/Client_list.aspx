<%@ Page language="C#" CodeFile="Client_list.aspx.cs" Inherits="BoatRenting.Client_list_aspx_cs" MaintainScrollPositionOnPostback="true" %>
...
$(document).ready(function(){
    ...
    <%--<div class="row">--%>
          <%-- <div class="col-xs-12 col-sm-12">--%>
           ...
           <asp:GridView ID="gvClientList"  HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White" OnRowDataBound="gvFacilitiesList_RowDataBound" PagerSettings-PageButtonCount="30"
        RowStyle-BackColor="#A1DCF2" AlternatingRowStyle-BackColor="White" AlternatingRowStyle-ForeColor="#000"
        runat="server" PageSize="100" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="OnPageIndexChanging" Width="100%" OnRowCommand="gvFacilitiesList_RowCommand" DataKeyNames="in_ClientID" ShowFooter="true" ShowHeader="true">
             <Columns>
                 ...
                 <asp:BoundField DataField="vc_firstName" HeaderText="First Name" />
                 <asp:BoundField DataField="vc_lastname" HeaderText="Last Name" />
                 <asp:BoundField DataField="vc_address" HeaderText="Address" />
                 <asp:BoundField DataField="vc_city" HeaderText="City" />
               
                 <asp:BoundField DataField="ch_Zip" HeaderText="Zip Code" />
            
                 <asp:BoundField DataField="vc_ContactPhone" HeaderText="Contact Phone" />
                 <asp:BoundField DataField="vc_mobile" HeaderText="Mobile Phone" />
                  <asp:BoundField DataField="vc_email" HeaderText="Email" />
                   <asp:BoundField DataField="vc_username" HeaderText="Username" />
                   <asp:BoundField DataField="vc_password" HeaderText="Password" />

...
namespace BoatRenting {
  ...
  public partial class users_delete_aspx_cs : System.Web.UI.Page
  {
    public string con = "";
    ...
    public object DeleteReg(double User_ID) 
    {
        cmd = new Command();
        cmd.ActiveConnection = oConn;
        cmd.CommandText = "SP_BR_USER_DEL";
        cmd.CommandType = adCmdStoredProc;
        //cmd.Parameters[1] = User_ID;
        //cmd.Parameters.Append(cmd.CreateParameter("@P_IN_UserID", adInteger, adParamInput, 4, 0));
        cmd.Parameters["@P_IN_UserID"].Value = User_ID;
        rs = cmd.Execute();
        return null;
    }

...
namespace BoatRenting {
  ...
  public partial class newuser_aspx_cs : System.Web.UI.Page
  {
    ...
    public object Country() 
    {
        ...
        rs = cmd.Execute();
        Response.Write("	<select name=\"new_user_country\" class=\"form_country\" style=\"width:150px\" onchange=\"javascript:LoadStates()\">\r\n");
    ...
    public object States() 
    {
        ...
        rs = cmd.Execute();
        Response.Write("	<select name=\"new_user_state\" class=\"form_state\" style=\"width:150px\">\r\n");

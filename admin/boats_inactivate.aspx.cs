...
namespace BoatRenting {
  ...
  public partial class boats_inactivate_aspx_cs : System.Web.UI.Page
  {
    public string con = "";
    ...
    public object InactivateReg(double boat_ID) 
    {
        ...
        //.CommandText = "SP_BR_PRICExBOATxTYPERENT_DEL"
        //.CommandType=adCmdStoredProc
        //.Parameters(1)=Session("MarinaID")
        //.Parameters(2)=Boat_ID
        //.execute()
        cmd.CommandText = "SP_BR_BOAT_INACTIVATE_UPD";
        ...
        //cmd.Parameters[1].Value = Convert.ToInt16(boat_ID);
        cmd.Execute();
        return null;
    }

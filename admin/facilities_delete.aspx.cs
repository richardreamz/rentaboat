...
namespace BoatRenting {
  ...
  public partial class facilities_delete_aspx_cs : System.Web.UI.Page
  {
    public string con = "";
    ...
    public string sListDelete = "";
    public int sLongitud = 0;
    ...
    public object DeleteReg(double facility_ID) 
    {
        ...
        cmd.CommandText = "SP_BR_MARINA_DEL";
        cmd.CommandType = adCmdStoredProc;
        //cmd.Parameters[1].Value = facility_ID;
        cmd.Parameters.Append(cmd.CreateParameter("@P_IN_MarinaID", adInteger, adParamInput, 4, 0));
        cmd.Parameters["@P_IN_MarinaID"].Value = facility_ID;
        rs = cmd.Execute();

            Util.DeleteAllStaticHTMLPages(facility_ID.ToString(), Server.MapPath("~/BoatHtml/"));
            Util.DeleteSiteMapElements(facility_ID.ToString(), Server.MapPath("~"));

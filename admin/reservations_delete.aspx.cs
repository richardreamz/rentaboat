...
namespace BoatRenting {
  ...
  public partial class reservations_delete_aspx_cs : System.Web.UI.Page
  {
    public string con = "";
    ...
    public object DeleteReg(string karts_ID) 
    {
        cmd = new Command();
        cmd.ActiveConnection = oConn;
        cmd.CommandText = "SP_BR_KARTDETAIL_DEL";
        cmd.CommandType = adCmdStoredProc;
        cmd.Parameters[1].Value = karts_ID;
        cmd.Parameters[2].Value = 0;
        //ES OUTPUT
        cmd.Execute();
        hdnBoatID = cmd.Parameters[2].Value;
        cmd.CommandText = "SP_BR_BOOKDATExBOAT_DEL";
        cmd.CommandType = adCmdStoredProc;
        cmd.Parameters[1].Value = Session["MarinaID"];
        cmd.Parameters[2].Value = hdnBoatID;
        cmd.Execute();

    ...
    <div class="row">
      <div class="col-md-12">
        <div class="table-responsive">
                    <asp:GridView ID="gvBookedBoats" runat="server" AutoGenerateColumns="false" DataKeyNames="in_BookDateID" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="gvBookedBoats_SelectedIndexChanged" CssClass="table table-responsive table-striped">
                      ...
                      <asp:TemplateField HeaderText="Agreement">
                        ...
                        <asp:TemplateField HeaderText="Send Email">
                         <ItemTemplate>
                          ...
                          <asp:Button ID="btnSendEmail" runat="server" Text="Send Email"  CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CommandName="Email" OnCommand="btnChangeDate_Command" CssClass="btn btn-primary" />    
                         </ItemTemplate>

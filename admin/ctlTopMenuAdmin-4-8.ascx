<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlTopMenuAdmin.ascx.cs" Inherits="ctlTopMenuAdmin" %>
...
<div class="menu_block clearfix">
        ...
        <!-- RESPONSIVE BUTTON MENU -->
           ...
           <div class="navbar-collapse collapse">
                  ...
                  <li class="sub-menu"><a>OWNERS<em class="indicator2"></em></a>
                  		<ul>                           
							<li><a href="BoatOwnerSignup.aspx">List Your Boat</a></li> 

...
namespace BoatRenting {
  ...
  public partial class fromrenttoown_aspx_cs : System.Web.UI.Page
  {
    public string con = "";
    ...
    public object Country() 
    {
        ...
        rs = cmd.Execute();
        Response.Write("	<select name=\"cmb_country\" class=\"water\" tabindex=\"1\" \r\n");
        Response.Write("onchange=\"javascript:LoadStates()\">\r\n");
    ...
    public object States() 
    {
        ...
        Response.Write("onchange=\"javascript:Search()\">\r\n");
    ...
    public object Facility() 
    {
        ...
        Response.Write("onchange=\"javascript:ClearFileds(1)\">\r\n");
    ...
    public object BodyWater() 
    {
        ...
        rs = cmd.Execute();
        Response.Write("	<select name=\"cmb_body\" class=\"water\" tabindex=\"3\" \r\n");
        Response.Write("onchange=\"javascript:ClearFileds(2)\">\r\n");
        Response.Write("	<option value=\"0\"> - Optional - </option>\r\n");
        while(!(rs.Eof))
        {
            Response.Write("	         <option value=\"");

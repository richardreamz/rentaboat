<%@ Page Language="C#" AutoEventWireup="true" CodeFile="renting-vs-owning.aspx.cs" Inherits="BoatRenting.renting_vs_owning" %>
                  ...
                  <ul class="navigation-menu">
                      ...
                      <li class="active nav-item dropdown">
                          ...
                          <div class="dropdown-menu sub-menu" aria-labelledby="navbarDropdown2">
                            ...
                            <a class="dropdown-item" href="renter_faqs.aspx" >RenterFAQ's</a>
        ...
        <section class="section pb-4 mt-5">
            <div class="container">
                ...
                <div class="col-md-6 mt-4">
                    <h2 class="text-uppercase">10 Reasons Why Renting A Boat Is A Better Choice</h2>
                    <ol>
                        <li>When you reach your boat’s location, hop on and take off! Do nothing but enjoy the water.</li>
                        <li>No need for a boat towing vehicle.</li>
                        <li>No washing, waxing, or storing the boat after a day on the water.</li>
                        <li>No boat maintenance expense of any kind.</li>
                        <li>No making an expensive boat payment during the months of winter storage.</li>
                        <li>Less expensive than owning a boat.</li>
                        <li>All boating equipment is provided (skis, jackets, ski rope, etc.)</li>
                        <li>No need to purchase a boating water recreational permit.</li>
                        <li>There are a variety of boats to choose from.</li>
                        <li>You can share the boating cost with friends.</li>
                    </ol>
                </div>
                <div class="col-md-6 mt-4">
                    <img style="max-width: 100%; height: auto" src="img/rent-vs-own.jpg" />
                </div>
                <div class="col-12 mt-4">
                    <h2 class="text-uppercase mt-4">The Average Boat Owner Spends more than $5,000 per year on recreational boating!</h2>
                    <p>We all know owning a boat is expensive. The initial purchase price of a boat is just the beginning. The average boat owner spends another $5,000 per year on maintenance, slip fees, insurance, fuel, and more. What’s more, the average boater hits the water 18 times per year. If you do the math, this means an average boat outing costs the owner more than $300 and that’s on the low side. If you consider a luxury yacht or a higher-end powerboat the numbers increase exponentially.</p>
                    <p>For those of you who have always longed to own a boat, it’s a smart move to try renting one first. Not only do you get to use the boat right away, but the owner takes care of all of the costs including license, maintenance, docking and storage fees, and insurance. These can really add up fast.</p>
                    <p>RentAboat.com gives you a wide variety of boats to choose from including luxury yachts, power boats of all sizes, sailboats, pontoon boats, jet skis, charter boats and more. We offer flexible scheduling to fit your needs. Choose either short-term rentals, such has half or full days, or rent a boat for your entire vacation.</p>
                    <p>All vessels come equipped with the necessary safety and recreational gear. This offers more savings to you, as a boat renter, as you don’t have to purchase hundreds or thousands of dollars worth of safety equipment and water toys to use. Ski boat rentals come with skis and life preservers. If you ask a question or two you may even get a quick instructional lesson from the dock. </p>
                    <p>Renting a boat before making the substantial investment of owning one just makes sense. RentAboat.com gives you the best of both worlds. Let us help make your next boating vacation perfect!</p>
                </div>
            </div>
            </div>
        </section>
